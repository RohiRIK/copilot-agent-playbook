...
def generate_catalog_row(metadata: dict[str, Any]) -> str:
    ...
    # Link to the built agent code
    agent_dir = path.stem
    deploy_link = f"[Code](../agents/{architecture}/{agent_dir}/README.md)"
...
def generate_index_md(agents: list[dict[str, Any]]) -> str:
    ...
    lines: list[str] = [
        ...
        "",
        "> This file is auto-generated by With LOVE and with TOO MUCH CAFFEINE ☕ "
