...
- [MFA Registration Gap Finder](mfa-gap-finder.md) — Identifies all users missing compliant MFA, not just break-glass accounts
...
- [Conditional Access Change Companion](conditional-access-companion.md) — Validates CA policy changes don't accidentally capture break-glass accounts
