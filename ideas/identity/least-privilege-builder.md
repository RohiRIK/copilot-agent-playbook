...
- [Break-Glass Account Validator](break-glass-validator.md) — Validates that break-glass accounts are excluded from PIM requirements
- [App Registration Governance](app-registration-governance.md) — Governs service principal role assignments alongside human privileged access
