...
- [Secrets & Certificates Expiry Monitor](secrets-certificates-expiry.md) — Monitors credential expiry for the same app registrations
- [Least Privilege Builder (PIM)](least-privilege-builder-pim.md) — Covers human privileged access alongside service principal governance
